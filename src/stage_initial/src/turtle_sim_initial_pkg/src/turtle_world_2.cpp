...
void laserScanCallback(const sensor_msgs::LaserScan::ConstPtr& msg) {
    ...
    if ((front_distance > 1.25) && (front_distance_pos_45 > 0.5) && (front_distance_neg_315 > 0.5 ) && (front_distance_pos_20 > 0.5 ) && (front_distance_neg_340 > 0.5 ) )
    {
...
int main(int argc, char** argv) {
    ...
    ros::init(argc, argv, "turtle_in_world_2");
